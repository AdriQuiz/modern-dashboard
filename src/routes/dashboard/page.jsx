      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
        <div className='card'>
          <div className='card-header'>
            <div className='rounded-lg w-fit bg-blue-500/20 p-2 text-blue-500 transition-colors dark:bg-blue-600/20 dark:text-blue-600'>
              <Package size={26} />
            </div>
              ...
              <div key={sale.id} className='flex items-center justify-between gap-x-4 py-2 pr-2'>
                <div className='flex items-center gap-x-4'>
                  ...
                  <div className='flex flex-col gap-y-2'>
                    ...
                    <p className='font-medium text-slate-600 text-sm dark:text-slate-400'>{sale.email}</p>
                  </div>
                </div>
